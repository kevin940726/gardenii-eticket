...
<html lang="en">
  ...
  <body>
    <div class="container">
      ...
      <form method="post" accept-charset="utf-8" action="/gardenii-eticket/index.php/member/edit_handler/<?=$event->event_id?>" id='launchform' class="form-horizontal" enctype="multipart/form-data">
